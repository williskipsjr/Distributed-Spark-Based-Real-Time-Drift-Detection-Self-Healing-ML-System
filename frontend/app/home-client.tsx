    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-background/95">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="space-y-8">
          <h2 className="text-2xl lg:text-3xl font-bold text-foreground text-center">Demo Surfaces</h2>
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {[
              {
                title: 'Forecast Overview',
                text: 'Hourly load forecast, predictions, and real-time telemetry.',
                href: '/dashboard/overview',
              },
              {
                title: 'Drift Logs',
                text: 'Current drift state, feature scores, and drift history timeline.',
                href: '/dashboard/drift',
              },
              {
                title: 'Model Registry',
                text: 'Active pointer, promotion history, and candidate readiness.',
                href: '/dashboard/models',
              },
              {
                title: 'Control Plane',
                text: 'Pipeline start/stop actions and service logs.',
              ...
              >
                <p className="telemetry-label">dashboard route</p>
