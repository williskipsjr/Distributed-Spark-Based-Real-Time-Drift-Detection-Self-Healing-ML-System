...
def _build_path(project_root: Path, *parts: str) -> Path:
    # Safety guard: only allow operations inside project root.
...
def reset_pipeline(clear_predictions: bool = True, hard_reset: bool = False) -> None:
    ...
    # Clears runtime outputs/checkpoints while preserving source assets.
    # ----------------------------------------------------
...
def main() -> None:
    # CLI entrypoint for safe cleanup before fresh E2E runs.
